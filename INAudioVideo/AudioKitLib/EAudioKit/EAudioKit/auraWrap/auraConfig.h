...
@interface auraConfig : NSObject

@property (nonatomic,assign)    int mp3Bitrate;
@property (nonatomic,assign)    int mp3Quality;
@property (nonatomic,assign)    int mp3EncodeType;
@property (nonatomic,assign)    int reverbType;

@property (nonatomic,assign)    float freqDetectDuration;
